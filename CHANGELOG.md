...
**Framework entry points** — `kanto/react` for typed wrappers, `kanto/vue` for
...
The bundled webfonts are **commercial**. Gilroy and Avenir Next Cyr account for
1.15 MB of the 1.74 MB unpacked package and are not covered by the MIT licence;
see `src/assets/fonts/README.md` before publishing anywhere public.
