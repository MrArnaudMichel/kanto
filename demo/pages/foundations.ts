...
const TYPE_SCALE: readonly (readonly [string, string])[] = [
  ...
  ['--font-title-h1', 'Titre H1 · 36/43 Manrope 600'],
  ['--font-title-h4', 'Titre H4 · 24/29 Manrope 400'],
  ['--font-title-h6', 'Titre H6 · 18 Manrope 600'],
  ['--font-normal-medium', 'Corps medium · 14 Mulish 500'],
  ['--font-normal-regular', 'Corps regular · 14 Mulish 400'],
  ['--font-normal-small', 'Corps small · 12 Mulish 400'],
