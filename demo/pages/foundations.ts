...
const TYPE_SCALE: readonly (readonly [string, string])[] = [
  ['--font-title-studio', 'Studio · 48/58 Manrope'],
  ['--font-title-h1', 'Heading H1 · 36/43 Manrope 600'],
  ['--font-title-h4', 'Heading H4 · 24/29 Manrope 400'],
  ['--font-title-h6', 'Heading H6 · 18 Manrope 600'],
  ['--font-normal-medium', 'Body medium · 14 Mulish 500'],
  ['--font-normal-regular', 'Body regular · 14 Mulish 400'],
  ['--font-normal-small', 'Body small · 12 Mulish 400'],
